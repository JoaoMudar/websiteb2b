...
/**
 * Landing pages de solução: compensação florestal e PRAD e recuperação de mata
 * ciliar.
 *
 * Existem separadas porque cada uma atende uma intenção de busca distinta e
 * tem H1, descrição, FAQ e mensagem de WhatsApp próprios. Não prometem
 * execução: o viveiro fornece a muda, o plantio é de quem contrata a obra.
 */
	...
	private static function paginas() {
		...
		return array (
			...
			'compensacao-florestal-e-prad' => array (
				...
				'title' => 'Compensação Florestal e PRAD em SC',
  ...
  <li><strong>Metalúrgica Riosulense</strong>: plantio de espécies nativas.</li>
				...
				'faq' => array (
					array ('pergunta' => 'Vocês elaboram o PRAD?',
						'resposta' => 'Não. O projeto é elaborado e protocolado pelo responsável técnico contratado para o seu licenciamento. O que fazemos é fornecer as mudas nativas previstas nele, produzidas sob responsabilidade técnica de engenheiro florestal e entregues com nota fiscal.' ),
			...
			'recuperacao-de-mata-ciliar' => array (
				...
				'title' => 'Recuperação de Mata Ciliar e Nascentes',
				...
				'cta_fim_texto' => '<strong>Não sabe quais espécies pedir?</strong> A partir do tipo de área e da faixa que precisa recompor, indicamos nativas de ocorrência regional do catálogo.',
				...
				'lateral_especies_link' => 'especies-para-recuperacao-de-area-degradada-e-mata-ciliar/',
				'servico' => 'Fornecimento de mudas nativas para recuperação de mata ciliar e nascentes',
...
<ul class="arrow-list">
  <li><strong>Mudas nativas de ocorrência regional</strong>, escolhidas a partir do mapa de ocorrência de cada espécie do catálogo.</li>
  <li><strong>Tubete, saco ou balde</strong>, conforme a altura que a muda precisa ter no dia do plantio.</li>
  <li><strong>Entrega com frota própria</strong> em PR, SC e RS, com nota fiscal, na data combinada com o cronograma de plantio.</li>
</ul>
<p>O plantio em si fica com você ou com a empresa que executar a obra. Já fornecemos as mudas da recuperação de mata ciliar da <strong>Novelsul, em Rio do Sul</strong>, e da recomposição de áreas de extração dos consórcios de duplicação da <strong>BR-101</strong>.</p>',
				...
				'faq' => array (
					...
					array ('pergunta' => 'Vocês só vendem as mudas ou também plantam?',
						'resposta' => 'Só fornecemos as mudas. O plantio e a manutenção ficam com você ou com a empresa que executar a obra. Em compensação, conseguimos programar a produção para a muda estar pronta na altura certa e na data do seu cronograma.' ),
