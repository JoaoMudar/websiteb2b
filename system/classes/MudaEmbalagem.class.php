...
class MudaEmbalagem {
	...
	/**
	 * Identificador da muda e embalagem
	 *
	 * @var Integer
	 */
	private $idMudaEmbalagem;
	 ...
	 * @return void
	 */
	public function __construct($idMudaEmbalagem) {

		$this->construtorMuda ( $idMudaEmbalagem );
	}
	 ...
	 * @return void
	 */
	public function setIdMudaEmbalagem($idMudaEmbalagem) {

		$this->idMudaEmbalagem = $idMudaEmbalagem;
	}
	 ...
	 * @return Integer
	 */
	public function getIdMudaEmbalagem() {

		return $this->idMudaEmbalagem;
	}
	...
	/**
	 * Constrói a lista de todas as mudas e embalagens existentes
	 *
	 * @return Array
	 */
	public function retornaListaMudas() {

		$listaMudasEmbalagens = array ();
		
		for($i = 1; $i <= 143; $i ++) {
			$listaMudasEmbalagens [] = new MudaEmbalagem ( $i );
		}
		
		return $listaMudasEmbalagens;
	}
	 ...
	 * @return void
	 */
	private function construtorMuda($idMudaEmbalagem) {

		switch ($idMudaEmbalagem) {
			case 1 :
				$this->setIdMudaEmbalagem ( 1 );
